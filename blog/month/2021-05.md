...
viewer3D.scaleComponentByKey('M1570783317812_0')

viewer3D.translateComponentByKey('M1570783317812_0')

viewer3D.rotateComponentByKey('M1570783317812_0')

viewer3D.getComponentWorldMatrixByKey("M1570783317812_0");
...
- js 代码分割
  ...
  - 动态导入（懒加载）
    ...
    1. 减少页面首次加载所需时间
    2. 按需导入所需模块，未使用的模块，不会请求模块文件，节省带宽
